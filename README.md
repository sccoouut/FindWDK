# FindWDK
CMake module for building drivers with Windows Development Kit (WDK) [![Build status](https://ci.appveyor.com/api/projects/status/3n7rdjtiifo1rxys/branch/master?svg=true)](https://ci.appveyor.com/project/sc6ut/findwdk/branch/master)
